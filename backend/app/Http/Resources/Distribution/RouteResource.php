...
class RouteResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'trip_plan_id'        => $this->trip_plan_id,
            'trip_plan'           => $this->whenLoaded('tripPlan', fn () => [
                'id'          => $this->tripPlan->id,
                'trip_number' => $this->tripPlan->trip_number,
                'origin'      => $this->tripPlan->origin,
                'destination' => $this->tripPlan->destination,
                'status'      => $this->tripPlan->status,
            ]),
